...
NOTE: Die REST-API /api/storage/volumes wird für mehr als nur den Dateizugriff verwendet. Sie wird vom System Manager und anderen grafischen Benutzeroberflächen zum Erstellen, Anzeigen und Ändern von Volumes verwendet.
